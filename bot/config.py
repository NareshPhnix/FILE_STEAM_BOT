...
class Telegram:
    ...
    ALLOWED_USER_IDS = env.get("ALLOWED_USER_IDS", "1676244457").split()
    BOT_USERNAME = env.get("TELEGRAM_BOT_USERNAME", "https://t.me/filetolinkks")
    BOT_TOKEN = env.get("TELEGRAM_BOT_TOKEN", "7146585357:AAHEb9a0Xyl9UDuSnUpwRqNpnT726APa5JE")
